...
import { FormField } from '@app/pages/form-constructor/form-constructor.model';
...
export class ControlEditorComponent implements OnInit {
  protected readonly formFieldList: Signal<FormField[]> = select(FormConstructorState.getFormFieldList$);
